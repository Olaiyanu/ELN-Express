...
const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    landing: {
      ...
      heroDesc: "The specialized delivery partner for fashion brands and small scale businesses. We handle your products with the care they deserve.",
      learnMore: "Learn More",
      servicesTitle: "Our Services",
      swiftDispatch: "Swift Dispatch",
      swiftDispatchDesc: "Same-day localized delivery for high-priority drops. We move as fast as your business.",
      productIntegrity: "Product Integrity",
      productIntegrityDesc: "Specialized handling for delicate items and essential inventory. Zero damage, 100% safety.",
      ...
      bulkShippingDesc: "Optimized routes for multiple drop-offs. Perfect for collection launches and inventory restocking.",
      scheduledPickups: "Scheduled Pickups",
      scheduledPickupsDesc: "Plan your week ahead. We'll be there exactly when your products are ready.",
      howItWorksTitle: "How It Works",
      howItWorksDesc: "Three simple steps to professional logistics for your business.",
      merchantSteps: [
        { title: "Create Mission", desc: "Enter delivery details and package specifications in your dashboard." },
        { title: "Rider Matches", desc: "Our system instantly alerts the nearest verified professional rider." },
        { title: "Track & Confirm", desc: "Watch the delivery in real-time until it reaches your customer's hands." }
      ],
      whyChooseUsTitle: "Why Growing Brands Choose ELN",
      whyChooseUsDesc: "We don't just move boxes; we protect your business's reputation.",
      reasons: [
        { title: "Professional Handling", desc: "Our riders are trained to handle high-value items and essential goods with extreme care." },
        { title: "Verified Network", desc: "Every rider undergoes a rigorous background check and security verification." },
        { title: "Business Integration", desc: "Custom delivery experiences that reflect your brand's professional status." }
      ],
      aboutTitle: "Moving Business",
      aboutSubtitle: "With Precision.",
      aboutDesc: "ELN Express was born from a simple observation: the modern world moves at the speed of light, but logistics was stuck in the past. We've built a network that understands the value of every product, from bespoke garments to essential small business inventory.",
  ...
  yo: {
    ...
    landing: {
      ...
      swiftDispatchDesc: "Ifijiṣẹ agbegbe ni ọjọ kanna fun awọn iṣẹ pataki. A n gbe ni iyara bi iṣowo rẹ ṣe n gbe.",
      productIntegrity: "Ìdúróṣinṣin Ọjà",
      productIntegrityDesc: "Mimu pataki fun awọn nkan ẹlẹgẹ ati ọja pataki. Ko si ibajẹ, 100% aabo.",
      realTimeGrid: "Grid Àkókò-Gidi",
      realTimeGridDesc: "Itumọ ni kikun pẹlu titele GPS for oniṣowo ati alabara ipari.",
      bulkShipping: "Gbigbe Olopobobo",
      bulkShippingDesc: "Awọn ipa-ọna iṣapeye fun awọn gbigbe silẹ lọpọlọpọ. Pipe fun awọn ifilọlẹ gbigba ati atunṣe ọja.",
      scheduledPickups: "Awọn Gbigbe Ti A Ṣeto",
      scheduledPickupsDesc: "Gbero ọsẹ rẹ siwaju. A yoo wa nibẹ gangan nigbati awọn ọja rẹ ba ṣetan.",
      howItWorksTitle: "Bawo Ni O Ṣe N Ṣiṣẹ",
      howItWorksDesc: "Awọn igbesẹ ti o rọrun mẹta si lọjistiki ọjọgbọn fun iṣowo rẹ.",
      merchantSteps: [
        { title: "Ṣẹda Iṣẹ", desc: "Tẹ awọn alaye ifijiṣẹ ati awọn pato package ninu dashibodu rẹ." },
        { title: "Ẹlẹṣin Baramu", desc: "Eto wa lẹsẹkẹsẹ ṣe itaniji ẹlẹṣin ọjọgbọn ti o sunmọ julọ ti a fọwọsi." },
        { title: "Tọpa & Jẹrisi", desc: "Wo ifijiṣẹ ni akoko gidi titi yoo fi de ọwọ alabara rẹ." }
      ],
      whyChooseUsTitle: "Kí nìdí tí àwọn ami iyasọtọ tí ń dàgbà fi yan ELN",
      whyChooseUsDesc: "A kii ṣe gbe awọn apoti nikan; a n daabobo orukọ iṣowo rẹ.",
      reasons: [
        { title: "Mimu Ọjọgbọn", desc: "Awọn ẹlẹṣin wa ni ikẹkọ lati mu awọn nkan ti o niye giga ati awọn ọja pataki pẹlu itọju to gaju." },
        { title: "Nẹtiwọọki Ti A Fọwọsi", desc: "Gbogbo ẹlẹṣin n gba ayẹwo abẹlẹ lile ati ijẹrisi aabo." },
        { title: "Iṣọkan Iṣòwò", desc: "Awọn iriri ifijiṣẹ aṣa ti o ṣe afihan ipo ọjọgbọn ti ami iyasọtọ rẹ." }
      ],
      aboutTitle: "Gbigbe Iṣòwò",
      aboutSubtitle: "Pẹlu Ipéye.",
      aboutDesc: "ELN Express ni a bi lati inu akiyesi ti o rọrun: agbaye ode oni n gbe ni iyara ina, ṣugbọn lọjistiki ti di ninu ohun ti o kọja. A ti kọ nẹtiwọọki kan ti o loye iye ti gbogbo ọja, lati awọn aṣọ ti a ṣe ni pataki si ọja iṣowo kekere pataki.",
