    ...
    <div className="min-h-screen selection:bg-eln/10">
      ...
      >
        ...
        <motion.section variants={itemVariants} className="text-center space-y-8">
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-eln/5 rounded-full text-eln text-[10px] font-black uppercase tracking-widest mb-4">
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative rounded-[3rem] overflow-hidden aspect-square shadow-2xl">
            ...
            />
            <div className="absolute inset-0 bg-eln/10 mix-blend-multiply"></div>
          </div>
        ...
        <motion.section variants={itemVariants} className="space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-gray-50 p-10 rounded-[2.5rem] space-y-6 hover:bg-eln hover:text-white transition-all duration-500 group">
                <div className="bg-eln/10 w-14 h-14 rounded-2xl flex items-center justify-center text-eln group-hover:bg-white/20 group-hover:text-white transition-colors">
        ...
        <motion.section variants={itemVariants} className="grid grid-cols-2 sm:grid-cols-3 gap-12 text-center py-20 border-y border-gray-100">
          <div className="space-y-2">
            <Award className="h-10 w-10 mx-auto text-eln" />
          ...
          <div className="space-y-2">
            <Users className="h-10 w-10 mx-auto text-eln" />
          ...
          <div className="space-y-2">
            <Globe className="h-10 w-10 mx-auto text-eln" />
        ...
        {/* CTA Section */}
        <motion.section variants={itemVariants} className="bg-gray-900 p-12 sm:p-20 rounded-[4rem] text-center space-y-8 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-eln/20 blur-[100px] rounded-full -mr-32 -mt-32"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-eln/20 blur-[100px] rounded-full -ml-32 -mb-32"></div>
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 pt-4">
              <Link to="/signup" className="px-10 py-5 bg-eln text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-eln/40 hover:scale-105 transition-all">
                {common.getStarted}
              </Link>
            </div>
          </div>
